...
const TopologyDescription = require('mongodb/lib/core/sdam/topology_description').TopologyDescription;
const TopologyType = require('mongodb/lib/core/sdam/common').TopologyType;
const events = require('mongodb/lib/core/sdam/events');
const Server = require('mongodb/lib/core/sdam/server').Server;
...
const createCompressionInfo = require('mongodb/lib/core/topologies/shared').createCompressionInfo;
const isRetryableError = require('mongodb/lib/core/error').isRetryableError;
const ClientSession = require('mongodb/lib/core/sessions').ClientSession;
const MongoError = require('mongodb/lib/core/error').MongoError;
const MongoServerSelectionError = require('mongodb/lib/core/error').MongoServerSelectionError;
const resolveClusterTime = require('mongodb/lib/core/topologies/shared').resolveClusterTime;
const SrvPoller = require('mongodb/lib/core/sdam/srv_polling').SrvPoller;
...
const serverSelection = require('mongodb/lib/core/sdam/server_selection');
