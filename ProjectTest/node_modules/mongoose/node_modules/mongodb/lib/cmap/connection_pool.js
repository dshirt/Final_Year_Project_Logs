...
const makeCounter = require('mongodb/lib/utils').makeCounter;
const MongoError = require('mongodb/lib/core/error').MongoError;
const Connection = require('mongodb/lib/cmap/connection').Connection;
